...
-->
    ...
    <body>
        ...
        <![endif]-->
			...
			TABLE NO: <input type="text" name="Filter">
			<input type="submit" value="SEARCH" id="submit"> 

			<table border="5" width="500" height="200" style="text-align:center">
						...
						if(isset($_POST['submit']))
						{
							...
							if (mysql_query("Select * from myorder WHERE tab='$f1'")) 
							{echo "<br>";}
							else
							{echo "WRONG";}
						}

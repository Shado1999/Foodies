                            ...
                            <div class="col-md-6">
                                <div class="main-menu">
                                    <ul>
                                        ...
                                        <li><a href="about-us.php">Feedback</a></li>
...
if(mysql_query("delete from myorder where cust_no=$curr_cust"))
{
echo "<H3>Successfully Deleted<br>";

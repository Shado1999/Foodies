        ...
        <![endif]-->
            ...
            <div id="products-post">
                <div class="container">
					...
					if(mysql_query("delete from myorder where cust_no='$c' and dish_no='$d'"))
						{
							echo "<center>Your dish is cancelled";
							echo "<br><br><a href='myorder.php'>Show My Orders</a></center>";

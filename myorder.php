            ...
            <div id="heading">
             ...
             <div id="products-post" style="background-image:url(images/bck6.jpg)">
                <div class="container">
					...
					<h3>
					<table border="5" width="500" height="200" style="text-align:center;back" background="images/bk7.jpg"	>
					...
					<?php
					$total=0;
					$q=mysql_query("select * from myorder where cust_no='$c'");
				   ...
				   echo "<tr>";
					...
					echo "<td>";
					echo "<a href='cancel.php?ds=$d'>Cancel</a>";

                ...
                <div class="container">
                    <div class="row">
						...
						<div class="heading-content">
                                <h2>Add Menu</h2>
                                <span>Home / <a href="about-us.html">Addmenu</a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
if($imageFileType == "jpg" || $imageFileType == "png" || $imageFileType == "jpeg" || $imageFileType == "gif")
{
		...
		$di="images/".$_FILES["pic"]["name"];
		$con=mysql_connect("localhost","root","");
	    mysql_select_db("hotel",$con);
		if(mysql_query("insert into $qt(Dish,Price,pic) values('$dn','$dp','$di')"))
								
			{
			echo "<br><br><h4>Saved Successfully";			
			}
		}

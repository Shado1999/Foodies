        ...
        <![endif]-->
                ...
                <div class="container">
                    <div class="row">
						...
						<div class="heading-content">
                                <h2>Place Order</h2>
                                <span>Home / <a href="myorder.php">/MyOrders</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="products-post" style="background-image:url(images/bck6.jpg)">
                <div class="container">
					...
					<h3>
					<font color="#000000">
					YOUR ORDER HAS BEEN PLACED...<br>YOU WILL SOON ENJOY THE MEAL!
					<?php 
...
?>
				...
				<h4><a href="feedback.php"> Click here</a> for your honest feedback.
				 </h4></div>

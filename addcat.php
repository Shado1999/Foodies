    ...
    <body>
        ...
        <![endif]-->
                ...
                <div class="container">
                    <div class="row">
						...
						<div class="heading-content">
                                <h2>ADD CATEGORY</h2>
                                <span>Home / <a href="addcat.php">Add Category</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="products-post" style="background-image: url(images/background2.jpg)">
				...
				<h3>Enter the Category:<input type="text" name="categ"><br><br>
		...
		$con=mysql_connect("localhost","root","");
	    mysql_select_db("hotel",$con);
		if((mysql_query("insert into category values('$n','$n')"))&&(mysql_query("create table $n(srno int Primary Key Auto_Increment,Dish varchar(50) Not Null,Price int Not Null,pic varchar(100))")))
								
			{
			
			echo "<br><br><h4>Saved Successfully...table created";
			}
			else
			echo "Failed";

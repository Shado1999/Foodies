        ...
        <![endif]-->
            ...
            <div id="products-post">
                <div class="container">
					...
					<h3>
					<table border="5" width="1000" height="200" style="text-align:center">
				...
				$t="roti";
					...
					<input type="text" name="qty"></th>
					<?php
					$qty=$_POST['qty'];
					echo $qty;
					echo "<th><a href='Order.php?ds=$s&q=$qty&pr=$r&l=$m'>Order</a></th>";
					echo "</tr>";
